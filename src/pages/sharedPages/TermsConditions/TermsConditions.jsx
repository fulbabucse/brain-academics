...
const TermsConditions = () => {
  return (
    <div className="px-2 lg:px-20 py-6">
      ...
      <p>
        Welcome to{" "}
        <span className="text-xl font-bold">Brains and Academics</span>
      </p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of <span className="text-xl font-bold">Brains and Academics</span>'s
        Website, located at https://brains-and-academics.web.app.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use{" "}
        <span className="text-xl font-bold">Brains and Academics</span> if you
      ...
      <p>
        ...
        <span className="text-xl font-bold">Brains and Academics</span>, you
        agreed to use cookies in agreement with the{" "}
        <span className="text-xl font-bold">Brains and Academics</span>'s
        Privacy Policy.{" "}
      </p>
      ...
      <p>
        ...
        <span className="text-xl font-bold">Brains and Academics</span> and/or
        its licensors own the intellectual property rights for all material on
        Brains and Academics. All intellectual property rights are reserved. You
        may access this from{" "}
        <span className="text-xl font-bold">Brains and Academics</span> for your
      ...
      <p>
        ...
        <span className="text-xl font-bold">Brains and Academics</span> does not
        ...
        <span className="text-xl font-bold">Brains and Academics</span>,its
        ...
        applicable laws, Brains and Academics shall not be liable for the
      ...
      <p>
        <span className="text-xl font-bold">Brains and Academics</span> reserves
      ...
      <p>
        You hereby grant{" "}
        <span className="text-xl font-bold">Brains and Academics</span> a
      ...
      <p>
        ...
        <span className="text-xl font-bold">Brains and Academics</span>; and (d)
      ...
      <p>
        ...
        e-mail to{" "}
        <span className="text-xl font-bold">Brains and Academics</span>. Please
      ...
      <p>
        No use of{" "}
        <span className="text-xl font-bold">Brains and Academics</span>'s logo
